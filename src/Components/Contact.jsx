...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "3f674860-f13d-4da1-8493-113a7a538590");
  ...
  return (
    ...
    className='text-center p-6 py-20 lg:px-32 w-full overflow-hidden' id='contact'>
      ...
      <form onSubmit={onSubmit} className='max-w-2xl mx-auto text-gray-600 pt-8'>
        ...
        <button className='bg-blue-600 text-white py-2 px-12 mb-10 rounded hover:bg-black'>{result ?result:"Send Message"}</button>
      </form>
    </div>
  );
}
